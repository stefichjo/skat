...
/* package skat-0.1.0.0 */
#ifndef VERSION_skat
#define VERSION_skat "0.1.0.0"
#endif /* VERSION_skat */
#ifndef MIN_VERSION_skat
#define MIN_VERSION_skat(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_skat */
...
#define CURRENT_COMPONENT_ID "skat-0.1.0.0-inplace-skat"
